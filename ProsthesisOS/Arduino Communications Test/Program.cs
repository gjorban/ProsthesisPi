...
namespace Arduino_Communications_Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            writer.WriteLine("Timestamp(ms), Duty Cycle, Pressure 1, pressure 2, P, I, D");
            test.TelemetryUpdate += new Action<ProsthesisCore.Telemetry.ProsthesisTelemetry.ProsthesisMotorTelemetry>(delegate(ProsthesisCore.Telemetry.ProsthesisTelemetry.ProsthesisMotorTelemetry obj) {
                ...
                string telemRow = string.Format("{0},{1},{2},{3},{4},{5},{6}", ts, obj.MotorDutyCycles[1], obj.OutputPressure[1], obj.OutputPressure[0], obj.ProportionalTunings[1], obj.IntegralTunings[1], obj.DifferentialTunings[1]);
